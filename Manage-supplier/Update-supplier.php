...
<body>
    ...
    <?php
        $sql = "Select * from public.supplier where supplier_id = '$id'";
        ...
        if(isset($_POST['update'])){
            ...
            if($name != "" && $email != "" && $phone != "" && $address != ""){
                $sql = "Update public.supplier set name='$name', email='$email', phone='$phone', address='$address' where supplier_id = $id";
                $qr = pg_query($conn, $sql);
