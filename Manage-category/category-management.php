        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><a href="Add-category.php">Add</a></th>
                </tr>
            </thead>
            <tbody>
                <?php 
                    ...
                    while($row = pg_fetch_assoc($qr)){?>
                        <tr>
                            ...
                            <td><a href="Update-category.php?id=<?= $row['id'] ?>">Update</a> | <a href="Delete-category.php?id=<?= $row['id']?>">Delete</a></td>
                        </tr>
                    <?php } ?>
            </tbody>
        </table>
